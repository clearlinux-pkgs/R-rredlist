...
Version  : 0.7.1
Release  : 47
URL      : https://cran.r-project.org/src/contrib/rredlist_0.7.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rredlist_0.7.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668454860
